...
public class FestivalesIO {
    ...
    public static Festival parsearLinea(String lineaFestival) {
        ...
        // Creamos una tabla Hash de la clase festivales.modelo.Estilo
        ...
        for (int i = 4; i < parseado.length; i++) {
            // Creamos una Variable de tipo festivales.modelo.Estilo que  convierte diferentes tipos de valores en cadena eliminando los caracteres blancos iniciales y finales de la cadena y en Mayusculas
        ...
        Festival jaialdi = new Festival(izena, tokia, hasieraData, iraupena, erak);
        return jaialdi;
    }
